...
namespace QRCoderTests
{
    ...
    public class QRGeneratorTests
    {
        ...
        {
            var qrData = QRCodeGenerator.CreateQrCode("123", QRCodeGenerator.ECCLevel.L);
        ...
        {
            var qrData = QRCodeGenerator.CreateQrCode("123ABC", QRCodeGenerator.ECCLevel.L);
            var result = string.Join("", qrData.ModuleMatrix.Select(x => x.ToBitString()).ToArray());
        ...
        {
            var qrData = QRCodeGenerator.CreateQrCode("äöü", QRCodeGenerator.ECCLevel.L);
            var result = string.Join("", qrData.ModuleMatrix.Select(x => x.ToBitString()).ToArray());
