...
namespace QRCoder
{
    public sealed class QRCodeGenerator : IDisposable
    {
        ...
        public static QRCodeData CreateQrCode(Payload payload) => GenerateQrCode(payload);
        ...
        /// <exception cref="Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
        /// <returns>Returns the raw QR code data which can be used for rendering.</returns>
        public static QRCodeData CreateQrCode(Payload payload, ECCLevel eccLevel) => GenerateQrCode(payload, eccLevel);
        ...
        /// <exception cref="Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
        /// <returns>Returns the raw QR code data which can be used for rendering.</returns>
        public static QRCodeData CreateQrCode(string plainText, ECCLevel eccLevel, bool forceUtf8 = false, bool utf8BOM = false, EciMode eciMode = EciMode.Default, int requestedVersion = -1) => GenerateQrCode(plainText, eccLevel, forceUtf8, utf8BOM, eciMode, requestedVersion);
        ...
        /// <exception cref="Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
        /// <returns>Returns the raw QR code data which can be used for rendering.</returns>
        public static QRCodeData CreateQrCode(byte[] binaryData, ECCLevel eccLevel) => GenerateQrCode(binaryData, eccLevel);
        ...
        /// <exception cref="Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
        /// <returns>Returns the raw QR code data which can be used for rendering.</returns>
        public static QRCodeData GenerateQrCode(Payload payload) => GenerateQrCode(payload.ToString(), payload.EccLevel, false, false, payload.EciMode, payload.Version);
        ...
        /// <exception cref="Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
        /// <returns>Returns the raw QR code data which can be used for rendering.</returns>
        public static QRCodeData GenerateQrCode(Payload payload, ECCLevel eccLevel) => GenerateQrCode(payload.ToString(), eccLevel, false, false, payload.EciMode, payload.Version);
        ...
        private static class ModulePlacer
        {
            ...
            private static class MaskPattern
            {
                ...
                public static int Score(ref QRCodeData qrCode)
                {
                    ...
                    int score4 = Math.Min(prevMultipleOf5, nextMultipleOf5) * 10;
